...
class NoteObject:
    def __init__(self):
        self.name = None
        self.note = self.note_recognizer()
    ...
    def note_recognizer(self):
        ...
        def listener(r):
            with sr.Microphone() as source:
                ...
                print("I have listened to you mate")
            return audio

        audio = listener(r)

        with open(".//output//piano.wav", "wb") as f:
            f.write(audio.get_wav_data())

        AUDIO_FILE = path.join(path.dirname(path.realpath(".//output/")), "piano.wav")

        audio_file = wave.open(AUDIO_FILE)
        Detected_Note = self.note_detect(audio_file)
    ...
    def note_detect(audio_file):
        ...
        note = 0
        name = np.array(
            ["C0", "C#0", "D0", "D#0", "E0", "F0", "F#0", "G0", "G#0", "A0", "A#0", "B0", "C1", "C#1", "D1", "D#1",
             "E1", "F1", "F#1", "G1", "G#1", "A1", "A#1", "B1", "C2", "C#2", "D2", "D#2", "E2", "F2", "F#2", "G2",
             "G2#", "A2", "A2#", "B2", "C3", "C3#", "D3", "D3#", "E3", "F3", "F3#", "G3", "G3#", "A3", "A3#", "B3",
             "C4", "C4#", "D4", "D4#", "E4", "F4", "F4#", "G4", "G4#", "A4", "A4#", "B4", "C5", "C5#", "D5", "D5#",
             "E5", "F5", "F5#", "G5", "G5#", "A5", "A5#", "B5", "C6", "C6#", "D6", "D6#", "E6", "F6", "F6#", "G6",
             "G6#", "A6", "A6#", "B6", "C7", "C7#", "D7", "D7#", "E7", "F7", "F7#", "G7", "G7#", "A7", "A7#", "B7",
        ...
        frequencies = np.array(
            [16.35, 17.32, 18.35, 19.45, 20.60, 21.83, 23.12, 24.50, 25.96, 27.50, 29.14, 30.87, 32.70, 34.65, 36.71,
             38.89, 41.20, 43.65, 46.25, 49.00, 51.91, 55.00, 58.27, 61.74, 65.41, 69.30, 73.42, 77.78, 82.41, 87.31,
             92.50, 98.00, 103.83, 110.00, 116.54, 123.47, 130.81, 138.59, 146.83, 155.56, 164.81, 174.61, 185.00,
             196.00, 207.65, 220.00, 233.08, 246.94, 261.63, 277.18, 293.66, 311.13, 329.63, 349.23, 369.99, 392.00,
             415.30, 440.00, 466.16, 493.88, 523.25, 554.37, 587.33, 622.25, 659.26, 698.46, 739.99, 783.99, 830.61,
    ...
    def set_brightness_with_note(self):
        the_note = self.note
        C_major = {"C4": 10, "C4#": 20, "D4": 25, "D4#": 30, "E4": 35, "F4": 45, "F4#": 55, "G4": 65, "G4#": 70,
                   "A4": 75, "A4#": 80, "B4": 90, "C5": 100}
        if the_note:
            self.percentage = C_major[the_note]
        else:
            self.percentage = None
    ...
    def turn_on_off_with_note(self):
        the_note = self.note
        if the_note == 'B3':
